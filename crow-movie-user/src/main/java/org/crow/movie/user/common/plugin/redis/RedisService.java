package org.crow.movie.user.common.plugin.redis;
...
public class RedisService {
    ...
    public int exists(String... keys) {
        Set<String> keySet = Stream.of(keys).collect(Collectors.toSet());
        return redisTemplate.opsForValue().multiGet(keySet).size();
    }
    ...
    public int hStrLen(String key, String field) {
        return String.valueOf(redisTemplate.opsForHash().get(key, field)).length();
    }
